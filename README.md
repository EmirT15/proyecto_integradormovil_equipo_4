...
* Se validaron los campos del formulario.
* Se agregaron estudiantes a la lista.
* Se eliminó un estudiante de la lista.
* Se probó la aplicación con diferentes tamaños de ventana.
